...
from flask import render_template, url_for, flash, redirect, request, make_response, jsonify, Flask, session
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender = 'noreply@texted.com', recipients = [user.email])
